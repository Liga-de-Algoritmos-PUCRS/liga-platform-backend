...
export const CreateFileByN8NRequestDecorator = applyDecorators(
  ApiOperation({
    summary: 'Upload a new file in n8n context',
    description:
      'This endpoint allows you to upload a new file in the system and atributo to a user.',
  }),
  ApiCreatedResponse({
...
export const GetFilesByNegociationIdDecorator = applyDecorators(
  ApiOperation({
    summary: 'List all files by negociation ID',
    description: 'This endpoint retrieves a list of all files for a negociation.',
  }),
  ApiOkResponse({
