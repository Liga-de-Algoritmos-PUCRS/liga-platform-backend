...
import { ResetPasswordRequestResponseDTO } from '@/modules/Auth/resetPassword/application/dtos/request-token.dto';
...
export class ResetPasswordController {
  ...
  ): Promise<ResetPasswordRequestResponseDTO> {
  ...
  @Public()
  @Post('validate')
  async validateResetPassword(@Body() body: ValidateResetPasswordDTO): Promise<void> {
