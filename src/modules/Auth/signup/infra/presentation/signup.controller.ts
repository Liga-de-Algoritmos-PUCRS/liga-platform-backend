...
import { SignupRequestResponseDTO } from '@/modules/Auth/signup/application/dtos/signup.dto';
import { ValidateSignupResponse } from '@/modules/Auth/signup/application/dtos/validate.dto';
@Controller('signup')
@ApiTags('Signup')
export class SignupController {
  ...
  @Post('validate')
  async validateToken(
    @Body() validateSignupDTO: ValidateSignupDTO,
