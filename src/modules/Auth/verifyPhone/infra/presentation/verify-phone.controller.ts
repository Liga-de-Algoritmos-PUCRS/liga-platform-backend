...
import { ValidateVerifyPhoneResponseDTO } from '@/modules/Auth/verifyPhone/application/dtos/verify-phone.dto';
...
export class VerifyPhoneController {
  ...
  @ValidateVerifyPhoneDecorator
  @Post('validate')
  async validateVerifyPhone(@Body() body: ValidateVerifyPhoneDTO, @GetUser() user): Promise<void> {
  ...
  async verifyPhone(
    ...
    @GetUser() user,
  ): Promise<ValidateVerifyPhoneResponseDTO> {
